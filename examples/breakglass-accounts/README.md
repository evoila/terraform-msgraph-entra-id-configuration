...
This example creates two emergency access accounts (break-glass accounts) and a security group containing both. The security group can be used to exclude those accounts from Conditional Access.
...
- <a name="requirement_msgraph"></a> [msgraph](#requirement_msgraph) (~> 0.3)
...
### <a name="output_breakglass_account_ids"></a> [breakglass_account_ids](#output_breakglass_account_ids)

Description: Object IDs of the created break-glass accounts. Add these to `breakglass_group_member_ids` and apply again to add the accounts as members of the "Break Glass Accounts" group.

### <a name="output_breakglass_accounts_group_id"></a> [breakglass_accounts_group_id](#output_breakglass_accounts_group_id)

Description: Object ID of the "Break Glass Accounts" group, to exclude from Conditional Access policies.

## Modules

The following Modules are called:

### <a name="module_entra"></a> [entra](#module_entra)
